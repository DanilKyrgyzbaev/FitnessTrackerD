package com.mad_devs.fitnesstrackerd.miBandConection;
...
import com.mad_devs.fitnesstrackerd.miBandConection.helpers.CustomBluetoothProfile;
...
public class MainActivity extends Activity {
    ...
    void initializeEvents() {
        ...
        btnGetBatteryInfo.setOnClickListener( v -> getBatteryStatus() );
        btnStartVibrate.setOnClickListener( v -> startVibrate() );
        btnStopVibrate.setOnClickListener( v -> stopVibrate() );
